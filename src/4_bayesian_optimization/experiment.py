...
def main(job_id, params):
    ...
    output = check_output(["python", "/home/hans/wart-detection/train.py", str(params['svm_gamma'][0]), str(params['svm_C'][0]), str(params['weight'][0])])  # run c binary (is faster than pure python
    print output
