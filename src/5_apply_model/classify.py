...
def classify_img(image_filename, threshold=10, window_size=(128, 128), min_size=(256,256), step_size=32, pyr_scale=0.75):
    ...
    clf = joblib.load('../../results/models/final_model/model.pkl')
    voca = np.load("../../results/models/final_model/vocabulary_model.npy")

    overall_start_time = time.time()

    # shouldn't there be also 100 features here?
    ...
    # UNCOMMENT THESE LINES TO SEE HEATMAP:
    ...
    if max_val > threshold:
        return True, max_val, detections
    else:
        return False, max_val, detections
...
if __name__ == '__main__':
    ...
    compliant, max_val, _ = classify_img(args['image'])
    if compliant:
